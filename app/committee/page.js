...
const Committee = () => {
  return (
    <div className={`${styles.CommitteeList} mb-lg`}>
      ...
      <div className={styles.List}>
        Prof. Balaraman Ravindran Professor, Indian Institute of Technology,
        Madras
      </div>
      <div className={styles.List}>
      ...
      <div className={styles.List}>
        Prof. Lalit Kumar Awasthi Director, NIT Uttarakhand
      </div>
      <div className={styles.List}>
        Prof. B. B. Chaudhuri Indian Statistical Institute Kolkata, INDIA
      </div>
      ...
      <div className={styles.List}>
        Dr. Maheshkumar H. Kolekar, Associate Professor, IIT, Patna, India
      </div>
      <div className={styles.List}>
        Prof. Ratnaiti Bhattacharya, IIT Guwahati, India
      </div>
      <div className={styles.List}>
      ...
      <div className={styles.List}>
        Prof. Angshul Majumdar Professor (CSE, ECE) (IIIT Delhi)
      </div>
      <div className={styles.List}>
        Prof. Harsh Verma Professor, CSE Department (NIT Jalandhar)
      </div>
      <div className={styles.List}>
    ...
    <div className={styles.subcommittee}>
      ...
      <div className={styles.List}>
        Dr. Divya Punia Assistant Professor, Dept of CSE, NIT Delhi
      </div>
      <div className={styles.List}>
        Dr. Karan Verma Assistant Professor, Dept of CSE, NIT Delhi
      </div>
